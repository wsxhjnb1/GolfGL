...
{    
    ...
    Mesh Model::processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        // 1. diffuse maps
        Textures diffuseMaps = loadMaterialTextures(material, aiTextureType_DIFFUSE, TDIFFUSE);
        textures.insert(textures.end(), diffuseMaps.begin(), diffuseMaps.end());
        // 2. specular maps
        Textures specularMaps = loadMaterialTextures(material, aiTextureType_SPECULAR, TSPECULAR);
        textures.insert(textures.end(), specularMaps.begin(), specularMaps.end());
        // 3. normal maps
        Textures normalMaps = loadMaterialTextures(material, aiTextureType_HEIGHT, TNORMAL);
        textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
        // 4. height maps
        Textures heightMaps = loadMaterialTextures(material, aiTextureType_AMBIENT, THEIGHT);
    ...
    Textures Model::loadMaterialTextures(aiMaterial *mat, aiTextureType type, TextureType typeName)
    {
        Textures textures;
